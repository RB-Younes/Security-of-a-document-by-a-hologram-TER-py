...
output_folder = "E:/dataset MIDV HOLO/Mosaics splited/"

# splitfolders.ratio(input_folder, output=output_folder, seed=42, ratio=(0.6, 0.2, 0.2))

# statestics after spliting the dataset
# stats train
num_train_Holo = len(os.listdir('E:/dataset MIDV HOLO/Mosaics splited/train/Holo'))
num_train_No_Holo = len(os.listdir('E:/dataset MIDV HOLO/Mosaics splited/train/No-Holo'))
TOT_train = num_train_Holo + num_train_No_Holo

# stats test
num_test_Holo = len(os.listdir('E:/dataset MIDV HOLO/Mosaics splited/test/Holo'))
num_test_No_Holo = len(os.listdir('E:/dataset MIDV HOLO/Mosaics splited/test/No-Holo'))
TOT_test = num_test_No_Holo + num_test_Holo
# stats valdidation
num_valid_Holo = len(os.listdir('E:/dataset MIDV HOLO/Mosaics splited/val/Holo'))
num_valid_No_Holo = len(os.listdir('E:/dataset MIDV HOLO/Mosaics splited/val/No-Holo'))
