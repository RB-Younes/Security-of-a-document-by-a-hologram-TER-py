...
filepath = "best-with-weights-pre/best_model.h5"
...
model.save('best-with-weights-pre/last_epoch_model.h5')

with open('best-with-weights-pre/history.pkl', 'wb') as file:
...
plt.savefig('best-with-weights-pre/Learning Curve (Loss).png')
plt.show()
...
ax.set_xlabel('Epoch')
ax.legend(['train', 'val'], loc='best')
plt.savefig('best-with-weights-pre/Learning Curve (Accuracy).png')
plt.show()
