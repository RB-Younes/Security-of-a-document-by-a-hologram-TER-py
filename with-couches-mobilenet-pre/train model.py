...
model.save('test/last_epoch_model.h5')

with open('test/history.pkl', 'wb') as file:
...
plt.savefig('test/Learning Curve (Loss).png')
plt.show()
...
ax.set_xlabel('Epoch')
ax.legend(['train', 'val'], loc='best')
plt.savefig('test/Learning Curve (Accuracy).png')
plt.show()
