...
filepath = "22-with-couches-mobilenet-pre/best_model.h5"
...
model.save('22-with-couches-mobilenet-pre/last_epoch_model.h5')

with open('22-with-couches-mobilenet-pre/history.pkl', 'wb') as file:
...
plt.savefig('22-with-couches-mobilenet-pre/Learning Curve (Loss).png')
plt.show()
...
ax.set_xlabel('Epoch')
ax.legend(['train', 'val'], loc='best')
plt.savefig('22-with-couches-mobilenet-pre/Learning Curve (Accuracy).png')
plt.show()
